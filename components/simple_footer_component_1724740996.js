...
<template>
    <footer id="footer-section" class="flex-1 bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-50 backdrop-filter backdrop-blur-lg">
        <div id="footer-container" class="max-w-screen-xl p-8 py-10 mx-auto lg:py-16 md:p-12 lg:p-14">
            ...
            <div class="flex">
                <div id="footer-text" class="flex-1 block text-base text-center text-pink-100 hover:text-white transition duration-300">
                    © 2023 BlockchainScout. Empowering users with the latest blockchain insights.
                </div>
            </div>
        </div>
    </footer>
